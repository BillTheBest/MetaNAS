...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RPCToken'
        db.create_table('services_rpctoken', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('last_used', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('services', ['RPCToken'])


    def backwards(self, orm):
        
        # Deleting model 'RPCToken'
        db.delete_table('services_rpctoken')
