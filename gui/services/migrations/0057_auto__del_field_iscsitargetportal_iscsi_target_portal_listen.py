...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'iSCSITargetPortal.iscsi_target_portal_listen'
        db.delete_column('services_iscsitargetportal', 'iscsi_target_portal_listen')


    def backwards(self, orm):
        
        # Adding field 'iSCSITargetPortal.iscsi_target_portal_listen'
        db.add_column('services_iscsitargetportal', 'iscsi_target_portal_listen', self.gf('django.db.models.fields.TextField')(default='0.0.0.0:3260', max_length=120), keep_default=False)
