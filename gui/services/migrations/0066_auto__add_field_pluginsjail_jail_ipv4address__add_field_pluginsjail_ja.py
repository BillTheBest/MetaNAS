...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('services_pluginsjail', 'jail_ipv4address', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')(default=''), keep_default=False)
    ...
    models = {
        ...
        'services.pluginsjail': {
            ...
            'jail_ipv4address': ('metanasUI.contrib.IPAddressField.IPAddressField', [], {}),
