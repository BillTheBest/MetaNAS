...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PluginsJail.jail_ip'
        db.delete_column('services_pluginsjail', 'jail_ip_id')


    def backwards(self, orm):
        
        # Adding field 'PluginsJail.jail_ip'
        db.add_column('services_pluginsjail', 'jail_ip', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['network.Alias'], null=True), keep_default=False)
