...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'iSCSITargetPortalIP'
        db.create_table('services_iscsitargetportalip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('iscsi_target_portalip_portal', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['services.iSCSITargetPortal'])),
            ('iscsi_target_portalip_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
            ('iscsi_target_portalip_port', self.gf('django.db.models.fields.SmallIntegerField')(default=3260)),
        ))
        db.send_create_signal('services', ['iSCSITargetPortalIP'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'iSCSITargetPortalIP', fields ['iscsi_target_portalip_ip', 'iscsi_target_portalip_port']
        db.delete_unique('services_iscsitargetportalip', ['iscsi_target_portalip_ip', 'iscsi_target_portalip_port'])

        # Deleting model 'iSCSITargetPortalIP'
        db.delete_table('services_iscsitargetportalip')
    ...
    models = {
        'network.alias': {
            ...
            'alias_v4address': ('metanasUI.contrib.IPAddressField.IP4AddressField', [], {'default': "''", 'blank': 'True'}),
            'alias_v4netmaskbit': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '3', 'blank': 'True'}),
            'alias_v6address': ('metanasUI.contrib.IPAddressField.IP6AddressField', [], {'default': "''", 'blank': 'True'}),
