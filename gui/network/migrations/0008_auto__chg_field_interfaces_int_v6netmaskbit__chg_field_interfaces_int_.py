...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('network_interfaces', 'int_ipv4address', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')())

        # Changing field 'Interfaces.int_ipv6address'
        db.alter_column('network_interfaces', 'int_ipv6address', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')())
        ...
        db.alter_column('network_globalconfiguration', 'gc_ipv4gateway', self.gf('metanasUI.contrib.IPAddressField.IP4AddressField')())

        # Changing field 'GlobalConfiguration.gc_ipv6gateway'
        db.alter_column('network_globalconfiguration', 'gc_ipv6gateway', self.gf('metanasUI.contrib.IPAddressField.IP6AddressField')())

        # Changing field 'GlobalConfiguration.gc_nameserver1'
        db.alter_column('network_globalconfiguration', 'gc_nameserver1', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')())

        # Changing field 'GlobalConfiguration.gc_nameserver3'
        db.alter_column('network_globalconfiguration', 'gc_nameserver3', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')())

        # Changing field 'GlobalConfiguration.gc_nameserver2'
        db.alter_column('network_globalconfiguration', 'gc_nameserver2', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Interfaces.int_ipv4address'
        db.alter_column('network_interfaces', 'int_ipv4address', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')(null=True))

        # Changing field 'Interfaces.int_ipv6address'
        db.alter_column('network_interfaces', 'int_ipv6address', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')(null=True))

        # Changing field 'Interfaces.int_v4netmaskbit'
        db.alter_column('network_interfaces', 'int_v4netmaskbit', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'GlobalConfiguration.gc_ipv4gateway'
        db.alter_column('network_globalconfiguration', 'gc_ipv4gateway', self.gf('metanasUI.contrib.IPAddressField.IP4AddressField')(null=True))

        # Changing field 'GlobalConfiguration.gc_ipv6gateway'
        db.alter_column('network_globalconfiguration', 'gc_ipv6gateway', self.gf('metanasUI.contrib.IPAddressField.IP6AddressField')(null=True))

        # Changing field 'GlobalConfiguration.gc_nameserver1'
        db.alter_column('network_globalconfiguration', 'gc_nameserver1', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')(null=True))

        # Changing field 'GlobalConfiguration.gc_nameserver3'
        db.alter_column('network_globalconfiguration', 'gc_nameserver3', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')(null=True))

        # Changing field 'GlobalConfiguration.gc_nameserver2'
        db.alter_column('network_globalconfiguration', 'gc_nameserver2', self.gf('metanasUI.contrib.IPAddressField.IPAddressField')(null=True))
    ...
    models = {
        'network.globalconfiguration': {
            ...
            'gc_ipv4gateway': ('metanasUI.contrib.IPAddressField.IP4AddressField', [], {'default': "''", 'blank': 'True'}),
            'gc_ipv6gateway': ('metanasUI.contrib.IPAddressField.IP6AddressField', [], {'default': "''", 'blank': 'True'}),
            'gc_nameserver1': ('metanasUI.contrib.IPAddressField.IPAddressField', [], {'default': "''", 'blank': 'True'}),
            'gc_nameserver2': ('metanasUI.contrib.IPAddressField.IPAddressField', [], {'default': "''", 'blank': 'True'}),
            'gc_nameserver3': ('metanasUI.contrib.IPAddressField.IPAddressField', [], {'default': "''", 'blank': 'True'}),
        ...
        'network.interfaces': {
            ...
            'int_ipv4address': ('metanasUI.contrib.IPAddressField.IPAddressField', [], {'default': "''", 'blank': 'True'}),
            'int_ipv6address': ('metanasUI.contrib.IPAddressField.IPAddressField', [], {'default': "''", 'blank': 'True'}),
