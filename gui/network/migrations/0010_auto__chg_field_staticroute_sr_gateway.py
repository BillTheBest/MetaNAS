...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StaticRoute.sr_gateway'
        db.alter_column('network_staticroute', 'sr_gateway', self.gf('metanasUI.contrib.IPAddressField.IP4AddressField')(max_length=120))


    def backwards(self, orm):
        
        # Changing field 'StaticRoute.sr_gateway'
        db.alter_column('network_staticroute', 'sr_gateway', self.gf('django.db.models.fields.CharField')(max_length=120))
