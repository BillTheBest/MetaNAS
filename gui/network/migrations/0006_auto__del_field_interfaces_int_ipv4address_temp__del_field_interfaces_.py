...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'network.interfaces': {
            ...
            'int_ipv4address': ('metanasUI.contrib.IPAddressField.IPAddressField', [], {'null': 'True', 'blank': 'True'}),
            'int_ipv6address': ('metanasUI.contrib.IPAddressField.IPAddressField', [], {'null': 'True', 'blank': 'True'}),
