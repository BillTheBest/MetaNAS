...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('network_alias', (
            ...
            ('alias_v4address', self.gf('metanasUI.contrib.IPAddressField.IP4AddressField')(default='', blank=True)),
            ('alias_v4netmaskbit', self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True)),
            ('alias_v6address', self.gf('metanasUI.contrib.IPAddressField.IP6AddressField')(default='', blank=True)),
    ...
    models = {
        ...
        'network.staticroute': {
            ...
            'sr_gateway': ('metanasUI.contrib.IPAddressField.IP4AddressField', [], {'max_length': '120'})
        },
        'network.vlan': {
