...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Interfaces.int_v6netmaskbit'
        db.alter_column('network_interfaces', 'int_v6netmaskbit', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

        # Changing field 'Interfaces.int_v4netmaskbit'
        db.alter_column('network_interfaces', 'int_v4netmaskbit', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
    ...
    models = {
        ...
        'network.interfaces': {
            ...
            'int_v4netmaskbit': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'int_v6netmaskbit': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'})
        },
