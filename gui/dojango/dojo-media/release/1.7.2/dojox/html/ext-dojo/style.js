...
define("dojox/html/ext-dojo/style", ["dojo/_base/kernel", "dojo/dom-style", "dojo/_base/lang", "dojo/_base/html", "dojo/_base/sniff",
	...
	lang.mixin(HtmlX["ext-dojo"].style, {
		...
		_setTransformFilter: function(/*DomNode*/ node, /*String*/ transform){
			...
			for(var i = 0, l = transforms.length; i < l; i++){
				...
				switch(currentTransform){
					...
					case "translateX":
						...
						m22 = props[3];
						tx = toPx(ct);
						tx && attr(n, "dojo-transform-matrmx-tx", tx);
					break;
					case "translateY":
						...
						m22 = props[3];
						ty = toPx(ct);
						ty && attr(n, "dojo-transform-matrmx-ty", ty);
					break;
					case "translate":
			...
			tx = parseInt(attr(n, "dojo-transform-matrmx-tx") || "0");
			ty = parseInt(attr(n, "dojo-transform-matrmx-ty") || "0");
