...
define("dojox/gfx3d/matrix", ["dojo/_base/lang", "./_base"], function(lang, gfx3d){
	...
	gfx3d.matrix.Matrix3D = function(arg){
		...
		// description: Normalizes a 3D matrmx-like object. If arrays is passed,
		//		all objects of the array are normalized and multiplied sequentially.
		// arg: Object
		//		a 3D matrmx-like object, a number, or an array of such objects
		if(arg){
	...
	lang.mixin(gfx3d.matrix, {
		...
		normalize: function(matrix){
			...
			// description: Converts any 3D matrmx-like object or an array of
		...
		clone: function(matrix){
			...
			// matrix: dojox.gfx3d.matrix.Matrix3D: a 3D matrmx-like object to be cloned
		...
		invert: function(matrix){
			...
			// matrix: dojox.gfx.matrix.Matrix3D: a 2D matrmx-like object to be inverted
		...
		multiply: function(matrix){
			...
			// matrix: dojox.gfx3d.matrix.Matrix3D...: a 3D matrmx-like object,
