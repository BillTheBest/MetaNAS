...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Settings.stg_ntpserver1'
        db.delete_column('system_settings', 'stg_ntpserver1')

        # Deleting field 'Settings.stg_ntpserver2'
        db.delete_column('system_settings', 'stg_ntpserver2')

        # Deleting field 'Settings.stg_ntpserver3'
        db.delete_column('system_settings', 'stg_ntpserver3')


    def backwards(self, orm):
        
        # Adding field 'Settings.stg_ntpserver1'
        db.add_column('system_settings', 'stg_ntpserver1', self.gf('django.db.models.fields.CharField')(default='0.ntp.metacomplex.com iburst maxpoll 9', max_length=120), keep_default=False)

        # Adding field 'Settings.stg_ntpserver2'
        db.add_column('system_settings', 'stg_ntpserver2', self.gf('django.db.models.fields.CharField')(default='1.ntp.metacomplex.com iburst maxpoll 9', max_length=120, blank=True), keep_default=False)

        # Adding field 'Settings.stg_ntpserver3'
        db.add_column('system_settings', 'stg_ntpserver3', self.gf('django.db.models.fields.CharField')(default='2.ntp.metacomplex.com iburst maxpoll 9', max_length=120, blank=True), keep_default=False)
    ...
    models = {
        ...
        'system.settings': {
            ...
            'stg_syslogserver': ('metanasUI.contrib.IPAddressField.IPAddressField', [], {'default': "''", 'blank': 'True'}),
