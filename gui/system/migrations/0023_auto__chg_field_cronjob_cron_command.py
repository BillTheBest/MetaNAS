...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CronJob.cron_command'
        db.alter_column('system_cronjob', 'cron_command', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'CronJob.cron_command'
        db.alter_column('system_cronjob', 'cron_command', self.gf('django.db.models.fields.CharField')(max_length=120))
