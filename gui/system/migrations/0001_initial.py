...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('system_settings', (
            ...
            ('stg_ntpserver1', self.gf('django.db.models.fields.CharField')(default='0.ntp.metacomplex.com iburst maxpoll 9', max_length=120)),
            ('stg_ntpserver2', self.gf('django.db.models.fields.CharField')(default='1.ntp.metacomplex.com iburst maxpoll 9', max_length=120, blank=True)),
            ('stg_ntpserver3', self.gf('django.db.models.fields.CharField')(default='2.ntp.metacomplex.com iburst maxpoll 9', max_length=120, blank=True)),
        ))
        ...
        stg.stg_language='en'
        stg.stg_timezone='Asia/Tehran'
        stg.stg_ntpserver1='0.ntp.metacomplex.com iburst maxpoll 9'
        stg.stg_ntpserver2='1.ntp.metacomplex.com iburst maxpoll 9'
        stg.stg_ntpserver3='2.ntp.metacomplex.com iburst maxpoll 9'
        stg.save()
