...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Rsync.rsync_user'
        db.alter_column('system_rsync', 'rsync_user', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'CronJob.cron_user'
        db.alter_column('system_cronjob', 'cron_user', self.gf('django.db.models.fields.CharField')(max_length=60))
