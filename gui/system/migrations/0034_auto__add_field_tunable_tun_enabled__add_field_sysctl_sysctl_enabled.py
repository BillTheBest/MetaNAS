...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tunable.tun_enabled'
        # Use 1 as default due to south+sqlite3 bug
        db.add_column('system_tunable', 'tun_enabled', self.gf('django.db.models.fields.BooleanField')(default=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Tunable.tun_enabled'
        db.delete_column('system_tunable', 'tun_enabled')

        # Deleting field 'Sysctl.sysctl_enabled'
        db.delete_column('system_sysctl', 'sysctl_enabled')
