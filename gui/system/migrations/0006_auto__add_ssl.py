...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SSL'
        db.create_table('system_ssl', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ssl_org', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('ssl_unit', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('ssl_email', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('ssl_city', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('ssl_state', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('ssl_country', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('ssl_common', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('ssl_certfile', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('system', ['SSL'])
    ...
    models = {
        ...
        'system.settings': {
            ...
            'stg_ntpserver1': ('django.db.models.fields.CharField', [], {'default': "'0.ntp.metacomplex.com iburst maxpoll 9'", 'max_length': '120'}),
            'stg_ntpserver2': ('django.db.models.fields.CharField', [], {'default': "'1.ntp.metacomplex.com iburst maxpoll 9'", 'max_length': '120', 'blank': 'True'}),
            'stg_ntpserver3': ('django.db.models.fields.CharField', [], {'default': "'2.ntp.metacomplex.com iburst maxpoll 9'", 'max_length': '120', 'blank': 'True'}),
