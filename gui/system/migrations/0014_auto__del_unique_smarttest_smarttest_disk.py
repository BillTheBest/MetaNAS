...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'SMARTTest', fields ['smarttest_disk']
        db.delete_unique('system_smarttest', ['smarttest_disk_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'SMARTTest', fields ['smarttest_disk']
        db.create_unique('system_smarttest', ['smarttest_disk_id'])
