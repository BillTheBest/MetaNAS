...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Settings.stg_syslogserver'
        db.add_column('system_settings', 'stg_syslogserver', self.gf('django.db.models.fields.CharField')(default='', max_length=120, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Settings.stg_syslogserver'
        db.delete_column('system_settings', 'stg_syslogserver')
