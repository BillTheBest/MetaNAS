...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('system_tunable', 'ldr_var', 'tun_var')

        db.rename_column('system_tunable', 'ldr_value', 'tun_value')

        db.rename_column('system_tunable', 'ldr_comment', 'tun_comment')


    def backwards(self, orm):

        db.rename_column('system_tunable', 'tun_var', 'ldr_var')

        db.rename_column('system_tunable', 'tun_value', 'ldr_value')

        db.rename_column('system_tunable', 'tun_comment', 'ldr_comment')
