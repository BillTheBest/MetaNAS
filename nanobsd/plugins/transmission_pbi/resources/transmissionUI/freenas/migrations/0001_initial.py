...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('metanas_transmission', (
        ...
        db.send_create_signal('metanas', ['Transmission'])


    def backwards(self, orm):
        
        # Deleting model 'Transmission'
        db.delete_table('metanas_transmission')


    models = {
        'metanas.transmission': {
