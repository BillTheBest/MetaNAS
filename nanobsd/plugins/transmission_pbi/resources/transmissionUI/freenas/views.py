...
from transmissionUI.metanas import forms, models, utils
...
class JsonResponse(HttpResponse):
    """
    This is a response class which implements MetaNAS GUI API
...
def treemenu(request):
    ...
    The MetaNAS GUI will access this view, expecting for a JSON
